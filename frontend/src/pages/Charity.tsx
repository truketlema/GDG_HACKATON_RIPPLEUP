...
const charities = [
  {
    ...
    description:
      "Providing access to clean drinking water in developing countries.",
  ...
  },
  {
    ...
    description:
      "Building schools and providing educational materials worldwide.",
    category: "Education",
...
const CharityPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (storedUserData) {
      ...
      if (donationHistory) {
        const donations = JSON.parse(donationHistory) as DonationHistory[];
  ...
  const handleDonate = () => {
    if (
      ...
      setTimeout(() => {
        ...
        setTotalDonated(totalDonated + donationAmount);
        ...
        // Get existing donation history or initialize empty array
        const existingHistory = JSON.parse(
          localStorage.getItem("donationHistory") || "[]"
        );
        const updatedHistory = [...existingHistory, donationRecord];

        // Save updated donation history to localStorage
        ...
        if (storedUserData) {
          ...
          const updatedUserData = {
            ...userData,
            points: (userData.points || 0) - donationAmount,
            totalDonated: (userData.totalDonated || 0) + donationAmount,
          };
      ...
      <div className="px-6 md:px-20 py-10 space-y-10 bg-gray-50 min-h-screen">
        ...
        <div className="text-center py-8">
          <h1 className="text-3xl md:text-5xl font-bold text-gray-800 mb-4">
            Donate Your Points,{" "}
            <span className="text-orange-500">Make a Difference!</span>
          </h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Your accumulated points can change lives. Select a charity and
            donate your points to support their cause.
          </p>
        </div>
                      ...
                      <img
                        ...
                        onError={(e) => {
                          (e.target as HTMLImageElement).src =
                            "https://via.placeholder.com/80?text=Charity";
                        }}
                      />
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg w-full max-w-md">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="flex justify-between mb-2">
                    <span className="text-gray-600">Value in Birr:</span>
                    <span className="font-medium">
                      {donationAmount * 10} Birr
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Remaining balance:</span>
                    <span className="font-medium">
                      {userPoints - donationAmount} points
                    </span>
                  </div>
                </div>
                ...
                <div className="pt-4 space-y-2">
                  <button
                    ...
                    disabled={donationAmount < 5 || donationAmount > userPoints}
                    className={`w-full py-3 px-4 rounded-lg font-semibold text-white ${
                      donationAmount >= 5 && donationAmount <= userPoints
        ...
        {donationSuccess && (
          <div className="fixed bottom-4 right-4 bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg flex items-center space-x-2 animate-fade-in">
            ...
            <span>
              Your donation of {donationAmount} points (worth{" "}
              {donationAmount * 10} Birr) was successful! Thank you.
            </span>
          </div>
        )}
